...
router.post('/', _loginRequired2.default, _AlunosControllers2.default.store);
router.put('/:id', _loginRequired2.default, _AlunosControllers2.default.update);
router.get('/:id', _AlunosControllers2.default.show);
router.delete('/:id', _loginRequired2.default, _AlunosControllers2.default.delete);
